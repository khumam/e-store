...
$halamanquery = mysqli_query($koneksi, "select * from desain order by id desc");
...
<head>
    ...
    <title>Statistik Jasa Desain - Garis Media</title>
...
<body>
<div class="container">
<h1 style="margin-top: 20px;text-align: center">Statistik Jasa Desain</h1>
