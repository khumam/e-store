...
if (!isset($_SESSION['admin'])) {
    ...
    $sqlpemesanan = "select count(nama_pesanan) as jumlah from foto";
    ...
    $halamanquery = mysqli_query($koneksi, "select * from foto order by id desc LIMIT $halamanmulai, $halaman");
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="bg-indah">
            ...
            <!-- Judul Page -->
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Statistik Foto</h1>
                    </div>
                </div>
            <!-- End Judul page -->
            ...
            <!-- Kotak di atas -->
                ...
                <div class="row mx-auto">
                    ...
                    <button type="button" class="btn btn-lg btn-primary" data-toggle="modal" data-target="#tambahfoto"><i class="fas fa-plus-square"></i> Tambah Data</button>
                    </div>
                    <div class="col-lg-3 mt-2">
                    <a href="../config/printfoto.php" class="btn btn-lg btn-success"><i class="fas fa-print"></i> Cetak Data</a>
                    </div>
                </div>
<br>
                <!-- ALert -->
                <?php if (isset($_SESSION['fotogagaltambah'])) {
                    echo "<div class='alert alert-danger'>" . $_SESSION['fotogagaltambah'] . "</div>";
                }
                unset($_SESSION['fotogagaltambah']); ?>
                ...
                <?php if (isset($_SESSION['fotosuksestambah'])) {
                    echo "<div class='alert alert-success'>" . $_SESSION['fotosuksestambah'] . "</div>";
                }
                unset($_SESSION['fotosuksestambah']); ?>
                            ...
                            <div class="panel-heading">
                                            ...
                                            <table class="table table-striped table-hover table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($data = mysqli_fetch_assoc($halamanquery)) {
                                                        ...
                                                        echo "<td><button class='btn btn-danger' data-toggle='modal' data-target='#hapusdatafoto" . $data['id'] . "'><i class='fas fa-trash-alt'></i></button>";
                                                        echo " <button class='btn btn-info' data-toggle='modal' data-target='#updatedatafoto" . $data['id'] . "'><i class='fas fa-pencil-alt'></i></button>";
                                                        echo " <a class='btn btn-success' href='../config/tambahprogress.php?idpesanan=" . $data['id_pesanan'] . "'><i class='fas fa-plus'></i></a></td>";
                                                        echo "</tr>";
                                                        $no++; ?>

                                                        <!-- MOdal Update -->
                                                        <div class="modal fade" id="updatedatafoto<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="tambahfotoLabel" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <span class="modal-title" id="tambahfotoLabel" style="font-size: 20px;">Update Data</span>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true"><i class="fas fa-times-circle"></i></span>
                                                                    </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <form action="../config/updatedatafoto.php" method="post">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit" class="btn btn-success" name="updatefoto">Update</button>
                                                                </div>
                                                                    </form>
                                                                </div>
                                                                </div>
                                                        ...
                                                        <!-- MOdal Hapus -->
                                                        <div class="modal fade" id="hapusdatafoto<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="tambahfotoLabel" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <span class="modal-title" id="tambahfotoLabel" style="font-size: 20px;">Hapus Data</span>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true"><i class="fas fa-times-circle"></i></span>
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Tutup</button>
                                                                    <a href="../config/hapusdatafoto.php?id=<?php echo $data['id']; ?>" class="btn btn-success">Hapus</a>
                                                                </div>                                                                
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="panel-footer">
                                    <ul class="pagination">
                                        ...
                                        <li><a href="foto.php?halaman=<?php echo $halamanpage - 1; ?>"><<</a></li>
                                        <?php 
                                    } ?>
                                        <?php for ($i = 1; $i <= $pages; $i++) { ?>
                                            <li><a href="foto.php?halaman=<?php echo $i; ?>"> <?php echo $i; ?> </a></li>
                                        <?php 
                                    } ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <span class="modal-title" id="tambahfotoLabel" style="font-size: 20px;">Tambah Data</span>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true"><i class="fas fa-times-circle"></i></span>
            </button>
        </div>
        <div class="modal-body">
            <form action="../config/tambahdatafoto.php" method="post">
            <div class="form-group">
